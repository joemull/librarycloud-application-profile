The below is an example of how the current document MODS Application Profile for LibraryCloud could be rendered in markdown (.md) format. A cheat sheet for markdown syntax can be found here: https://github.com/adam-p/markdown-here/wiki/Markdown-Cheatsheet
